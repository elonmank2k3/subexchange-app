...
public class UserService {
    ...
    public Map<String, String> handleReferralCodeInput(String googleUserId, String referralCode) {
        ...
        if (inviter == null) {
            ...
            User invitee = userRepository.findByGoogleUserId(googleUserId).orElse(null);
    ...
    public User findUserByGoogleUserId(String googleUserId) {
        return userRepository.findByGoogleUserId(googleUserId).orElse(null);
    }
    public User findUserByAuthorization(String authorization) throws AccessDeniedException {
        ...
        User user = findUserByGoogleUserId(String.valueOf(userInfo.get("sub")));
        return user;
    }
    ...
    private void saveEarningHistory(User user, Integer coinPerView, String activity) {
        EarningHistory earningHistory = new EarningHistory();
        earningHistory.setUser(user);
        earningHistory.setCoinPerView(coinPerView);
